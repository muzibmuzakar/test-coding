    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between">
            ...
            <a class="bg-blue-500 px-4 py-2 rounded-lg text-white hover:bg-blue-400"
                href="{{ route('kategori.create') }}">Tambah</a>
        </div>
    </x-slot>
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="flex pt-3">
                                            <a class="mr-2 px-2 py-1 bg-yellow-600 text-white hover:bg-yellow-500 rounded-md" href="{{route('kategori.edit',$item->id)}}">Edit</a>
